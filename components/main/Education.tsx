...
const Education = () => {
  return (
    <section className="relative max-w-7xl mx-auto px-4 sm:px-8 py-20" id="education">
      <h1 className="text-5xl font-bold text-center mb-32 text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-cyan-500 relative z-10">
        Education
      </h1>

      {/* Vertical dotted timeline line */}
      <div className="absolute top-45 left-1/2 transform -translate-x-1/2 h-280 w-[2px] bg-gradient-to-b from-purple-500 to-cyan-500 bg-[length:4px_10px] bg-repeat-y bg-dotted z-0 animate-pulse" />
